...
<body>
    <div class="container">
        ...
        <div class="text-center">
            ...
            <a href="/user/list" class="btn btn-primary btn-lg btn-action">Gestionar Scooters</a>
            <a href="/curs/list" class="btn btn-success btn-lg btn-action">Gestionar Rents</a>
        </div>
    </div>
